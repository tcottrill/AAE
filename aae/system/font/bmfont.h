...
// -----------------------------------------------------------------------------
// BMFont - Bitmap Font Renderer (OpenGL 4 version)
// Loads AngelCode .fnt file and renders bitmap glyphs using VAO/VBO and shaders
// -----------------------------------------------------------------------------
class BMFont
{
public:
	...
	void  setKerning(bool enable) { useKerning = enable; }
	...
	// OpenGL 4
	// -------------------------------------------------------------------------
	bool  InitGL();      // Must be called after font is loaded
	void  Render();      // Draw batched text
