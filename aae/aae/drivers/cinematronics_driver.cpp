...
ART_LOAD("solarq_aae.zip", "solarq.png", ART_TEX, 0)
ART_LOAD("solarq_aae.zip", "solaroverlay.png", ART_TEX, 1)
...
AAE_DRIVER_CPUS(AAE_CPU_ENTRY(CPU_CCPU, 4980750, 1, 1, 0, 0, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr),
	...
	AAE_CPU_NONE_ENTRY(),
	AAE_CPU_NONE_ENTRY())
	AAE_DRIVER_VIDEO_CORE(38, VIDEO_TYPE_VECTOR | VECTOR_USES_BW | VECTOR_USES_OVERLAY1 | VEC_OVER_HACK, ORIENTATION_DEFAULT)
	...
	AAE_DRIVER_CPUS(AAE_CPU_ENTRY(CPU_CCPU, 4980750, 1, 1, 0, 0, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr),
		...
		AAE_CPU_NONE_ENTRY(),
		AAE_CPU_NONE_ENTRY())
	AAE_DRIVER_VIDEO_CORE(38, VIDEO_TYPE_VECTOR | VECTOR_USES_BW | VECTOR_USES_OVERLAY2 | VEC_OVER_HACK, ORIENTATION_DEFAULT)
	...
	AAE_DRIVER_CPUS(AAE_CPU_ENTRY(CPU_CCPU, 4980750, 1, 1, 0, 0, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr),
		AAE_CPU_NONE_ENTRY(),
		AAE_CPU_NONE_ENTRY(),
		AAE_CPU_NONE_ENTRY())AAE_DRIVER_VIDEO_CORE(38, VIDEO_TYPE_VECTOR | VECTOR_USES_BW | VECTOR_USES_OVERLAY1, ORIENTATION_ROTATE_270)
	AAE_DRIVER_SCREEN(1024, 768, 0, 1024, 0, 768)
	AAE_DRIVER_RASTER_NONE()
	AAE_DRIVER_HISCORE_NONE()
	AAE_DRIVER_VECTORRAM(0, 0)
