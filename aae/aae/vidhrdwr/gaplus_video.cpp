/***************************************************************************
  ...
  gaplus_video.cpp  --  AAE video hardware for gaplus
*/
...
// This must be called after gaplus_vh_start so that the GFX elements are
...
WRITE_HANDLER_NS(gaplus_starfield_control_w) {
	gaplus_starfield_control[address] = data;
}
...
int gaplus_vh_start(void) {
	...
	starfield_init();
	LOG_INFO("Gaplus Video Start Called");
