...
ROM_LOAD("034599-01.r3",  0x4800, 0x800)
ROM_LOAD("034598-01.np3", 0x5000, 0x800)
ROM_LOAD("034597-01.m3",  0x5800, 0x800)
ROM_LOAD("034572-02.f1",  0x6000, 0x800)
ROM_LOAD("034571-02.de1", 0x6800, 0x800)
ROM_LOAD("034570-01.c1",  0x7000, 0x800)
ROM_LOAD("034569-02.b1",  0x7800, 0x800)
...
ROM_REGION(0x10000, CPU0)
ROM_LOAD("035127-02.np3", 0x5000, 0x800)
ROM_LOAD("035145ll.de1", 0x6800, 0x800)
ROM_LOAD("035144ll.c1", 0x7000, 0x800)
ROM_LOAD("035143ll.b1", 0x7800, 0x800)
//ROM_RELOAD(0xf800, 0x800)
ROM_END

ROM_START(asterock)    //ASTEROCK
ROM_REGION(0x10000, 0)
ROM_LOAD("10505.0", 0x5000, 0x400)
ROM_LOAD("10505.1", 0x5400, 0x400)
ROM_LOAD("10505.2", 0x6800, 0x400)
ROM_LOAD("10505.3", 0x6c00, 0x400)
ROM_LOAD("10505.4", 0x7000, 0x400)
ROM_LOAD("10505.5", 0x7400, 0x400)
ROM_LOAD("10505.6", 0x7800, 0x400)
ROM_LOAD("10505.7", 0x7c00, 0x400)
//ROM_RELOAD(0xfc00, 0x400)
ROM_END

ROM_START(asteroi1) //VERSION 1
ROM_REGION(0x10000, 0)
ROM_LOAD("035127-01.np3", 0x5000, 0x800)
ROM_LOAD("035145-01.ef2", 0x6800, 0x800)
ROM_LOAD("035144-01.h2", 0x7000, 0x800)
ROM_LOAD("035143-01.j2", 0x7800, 0x800)
//ROM_RELOAD(0xf800, 0x800)
ROM_END

ROM_START(asteroid) //VERSION 2
ROM_REGION(0x10000, 0)
ROM_LOAD("035127-02.np3", 0x5000, 2048)
ROM_LOAD("035145-04e.ef2", 0x6800, 2048)
ROM_LOAD("035144-04e.h2", 0x7000, 2048)
ROM_LOAD("035143-02.j2", 0x7800, 2048)
//ROM_RELOAD(0xf800, 2048)
ROM_END

ROM_START(astdelux)
ROM_REGION(0x10000, 0)
ROM_LOAD("036430-02.d1",  0x6000, 0x0800)
ROM_LOAD("036431-02.ef1", 0x6800, 0x0800)
ROM_LOAD("036432-02.fh1", 0x7000, 0x0800)
ROM_LOAD("036433-03.j1",  0x7800, 0x0800)
//ROM_RELOAD(0xf800, 0x800)
// Vector ROM
ROM_LOAD("036800-02.r2",  0x4800, 0x0800)
ROM_LOAD("036799-01.np2", 0x5000, 0x0800)
ROM_END

ROM_START(astdelu2)
ROM_REGION(0x10000, 0)
ROM_LOAD("036430-01.d1",  0x6000, 0x0800)
ROM_LOAD("036431-01.ef1", 0x6800, 0x0800)
ROM_LOAD("036432-01.fh1", 0x7000, 0x0800)
ROM_LOAD("036433-02.j1",  0x7800, 0x0800)
//ROM_RELOAD(0xf800, 0x800)
// Vector ROM
ROM_LOAD("036800-01.r2",  0x4800, 0x0800)
ROM_LOAD("036799-01.np2", 0x5000, 0x0800)
ROM_END

ROM_START(astdelu1) //VERSION 1
ROM_REGION(0x10000, 0)
ROM_LOAD("036800-01.r2",  0x4800, 0x800)
ROM_LOAD("036799-01.np2", 0x5000, 0x800)
ROM_LOAD("036430-01.d1",  0x6000, 0x800)
ROM_LOAD("036431-01.ef1", 0x6800, 0x800)
ROM_LOAD("036432-01.fh1", 0x7000, 0x800)
ROM_LOAD("036433-01.j1",  0x7800, 0x800)
//ROM_RELOAD(0xf800, 0x800)
ROM_END
...
ROM_REGION(0x10000, 0)
/* Vector ROM */
ROM_LOAD("136017-107.l7",  0x2800, 0x0800)
ROM_LOAD("136017-108.mn7", 0x3000, 0x1000)
ROM_LOAD("136017-109.np7", 0x4000, 0x1000)
ROM_LOAD("136017-110.r7",  0x5000, 0x1000)
/* Program ROM */
ROM_LOAD("136017-101.d1",  0x9000, 0x1000)
ROM_LOAD("136017-102.ef1", 0xa000, 0x1000)
ROM_LOAD("136017-103.h1",  0xb000, 0x1000)
ROM_LOAD("136017-104.j1",  0xc000, 0x1000)
ROM_LOAD("136017-105.kl1", 0xd000, 0x1000)
ROM_LOAD("136017-106.m1",  0xe000, 0x1000)
...
ROM_REGION(0x10000, 0)
/* Vector ROM */
ROM_LOAD("vg4800", 0x4800, 0x0800)
ROM_LOAD("vg5000", 0x5000, 0x1000)

/* Program ROM */
ROM_LOAD("a000", 0xa000, 0x1000)
ROM_LOAD("b000", 0xb000, 0x1000)
ROM_LOAD("c000", 0xc000, 0x1000)
ROM_LOAD("d000", 0xd000, 0x1000)
ROM_LOAD("e000", 0xe000, 0x1000)
ROM_RELOAD(0xf000, 0x1000) // for reset/interrupt vectors
ROM_END
...
ROM_REGION(0x10000, 0)
/* Vector ROM */
ROM_LOAD("136010-210.l7",  0x2800, 0x0800)
ROM_LOAD("136010-207.mn7", 0x3000, 0x1000)
ROM_LOAD("136010-208.np7", 0x4000, 0x1000)
ROM_LOAD("136010-309.r7",  0x5000, 0x1000)
/* Program ROM */
ROM_LOAD("136010-301.d1",  0x9000, 0x1000)
ROM_LOAD("136010-302.ef1", 0xa000, 0x1000)
ROM_LOAD("136010-303.h1",  0xb000, 0x1000)
ROM_LOAD("136010-304.j1",  0xc000, 0x1000)
ROM_LOAD("136010-305.kl1", 0xd000, 0x1000)
ROM_LOAD("136010-306.m1",  0xe000, 0x1000)
ROM_RELOAD(0xf000, 0x1000) // for reset/interrupt vectors
ROM_END
...
ROM_LOAD("136010-207.mn7", 0x3000, 0x1000)
ROM_LOAD("136010-208.np7", 0x4000, 0x1000)
ROM_LOAD("136010-209.r7",  0x5000, 0x1000)
/* Program ROM */
ROM_LOAD("136010-201.d1",  0x9000, 0x1000)
ROM_LOAD("136010-202.ef1", 0xa000, 0x1000)
ROM_LOAD("136010-203.h1",  0xb000, 0x1000)
ROM_LOAD("136010-204.j1",  0xc000, 0x1000)
ROM_LOAD("136010-205.kl1", 0xd000, 0x1000)
ROM_LOAD("136010-206.m1",  0xe000, 0x1000)
ROM_RELOAD(0xf000, 0x1000) //for reset/interrupt vectors
ROM_END
...
ROM_REGION(0x10000, 0)
/* Vector ROM */
ROM_LOAD("136010-010.l7",  0x2800, 0x0800)
ROM_LOAD("136010-007.mn7", 0x3000, 0x1000)
ROM_LOAD("136010-008.np7", 0x4000, 0x1000)
/* Program ROM */
ROM_LOAD("136010-001.d1",  0x9000, 0x1000)
ROM_LOAD("136010-002.ef1", 0xa000, 0x1000)
ROM_LOAD("136010-003.h1",  0xb000, 0x1000)
ROM_LOAD("136010-004.j1",  0xc000, 0x1000)
ROM_LOAD("136010-005.kl1", 0xd000, 0x1000)
ROM_LOAD("136010-006.m1",  0xe000, 0x1000)
ROM_RELOAD(0xf000, 0x1000) // for reset/interrupt vectors
ROM_END
...
ROM_REGION(0x10000, 0)
/* Vector ROM */
ROM_LOAD("136006-106.r7", 0x2800, 0x0800)
ROM_LOAD("136006-107.np7", 0x3000, 0x1000)
/* Program ROM */
ROM_LOAD("136006-201.r1", 0x4000, 0x1000)
ROM_LOAD("136006-102.np1", 0x5000, 0x1000)
ROM_LOAD("136006-103.m1", 0x6000, 0x1000)
ROM_LOAD("136006-104.kl1", 0x7000, 0x1000)
ROM_LOAD("136006-105.j1", 0x8000, 0x1000)
ROM_LOAD("136006-105.j1", 0x9000, 0x1000)
ROM_LOAD("136006-105.j1", 0xa000, 0x1000)
ROM_LOAD("136006-105.j1", 0xb000, 0x1000)
ROM_LOAD("136006-105.j1", 0xc000, 0x1000)
ROM_LOAD("136006-105.j1", 0xd000, 0x1000)
ROM_LOAD("136006-105.j1", 0xe000, 0x1000)
ROM_RELOAD(0xf000, 0x1000)	/* for reset/interrupt vectors */
ROM_END
...
ROM_REGION(0x10000, 0)
/* Vector ROM */
ROM_LOAD("136006-006.r7", 0x2800, 0x0800)
ROM_LOAD("136006-007.np7", 0x3000, 0x1000)
/* Program ROM */
ROM_LOAD("136006-001.r1", 0x4000, 0x1000)
ROM_LOAD("136006-002.np1", 0x5000, 0x1000)
ROM_LOAD("136006-003.m1", 0x6000, 0x1000)
ROM_LOAD("136006-004.kl1", 0x7000, 0x1000)
ROM_LOAD("136006-005.j1", 0x8000, 0x1000)
ROM_LOAD("136006-005.j1", 0x9000, 0x1000)
ROM_LOAD("136006-005.j1", 0xa000, 0x1000)
ROM_LOAD("136006-005.j1", 0xb000, 0x1000)
ROM_LOAD("136006-005.j1", 0xc000, 0x1000)
ROM_LOAD("136006-005.j1", 0xd000, 0x1000)
ROM_LOAD("136006-005.j1", 0xe000, 0x1000)
ROM_RELOAD(0xf000, 0x1000)	/* for reset/interrupt vectors */
ROM_END

ROM_START(aliensv) //ALIENS PROTO
ROM_REGION(0x10000, 0)
...
ROM_LOAD("vb_h1.bin", 0xa800, 0x0800)
//ROM_LOAD("136002.113", 0xb000, 0x0800)
//ROM_LOAD("136002.114", 0xb800, 0x0800)
//ROM_LOAD("136002.115", 0xc000, 0x0800)
//ROM_LOAD("136002.116", 0xc800, 0x0800)
//ROM_LOAD("136002.117", 0xd000, 0x0800)
...
ROM_LOAD("vbrakout.113", 0x9000, 0x0800)
ROM_LOAD("vbrakout.114", 0x9800, 0x0800)
...
ROM_END
/*
ROM_START(vbrakout)//VECTOR BREAKOUT
ROM_REGION(0x10000, 0)
ROM_LOAD("vb_d1.bin", 0x9000, 0x0800)
ROM_LOAD("vb_e1.bin", 0x9800, 0x0800)
ROM_LOAD("vb_f1.bin", 0xa000, 0x0800)
...
ROM_LOAD("136002-133.d1", 0x9000, 0x0800)
ROM_LOAD("136002-134.f1", 0x9800, 0x0800)
ROM_LOAD("136002-115.f1", 0xa000, 0x0800)
ROM_LOAD("136002-316.h1", 0xa800, 0x0800)
ROM_LOAD("136002-217.j1", 0xb000, 0x0800)
...
ROM_LOAD_16B("spacewar.2r", 0x0001, 0x800)
ROM_END

ROM_START(barrier)
ROM_REGION(0x10000, 0)
ROM_LOAD_16B("barrier.t7", 0x0000, 0x800)
ROM_LOAD_16B("barrier.p7", 0x0001, 0x800)
ROM_END

ROM_START(starhawk)
ROM_REGION(0x1000, 0)
ROM_LOAD_16B("u7", 0x0000, 0x800)
ROM_LOAD_16B("r7", 0x0001, 0x800)
ROM_END

ROM_START(speedfrk)
ROM_REGION(0x10000, 0)
ROM_LOAD_16B("speedfrk.t7", 0x0000, 0x800)
ROM_LOAD_16B("speedfrk.p7", 0x0001, 0x800)
ROM_LOAD_16B("speedfrk.u7", 0x1000, 0x800)
ROM_LOAD_16B("speedfrk.r7", 0x1001, 0x800)
ROM_END

ROM_START(solarq)
ROM_REGION(0x10000, 0)
ROM_LOAD_16B("solar.6t", 0x0000, 0x1000)
ROM_LOAD_16B("solar.6p", 0x0001, 0x1000)
ROM_LOAD_16B("solar.6u", 0x2000, 0x1000)
ROM_LOAD_16B("solar.6r", 0x2001, 0x1000)
ROM_END

ROM_START(sundance)
ROM_REGION(0x10000, 0)
ROM_LOAD_16B("sundance.t7", 0x0000, 0x800)
ROM_LOAD_16B("sundance.p7", 0x0001, 0x800)
ROM_LOAD_16B("sundance.u7", 0x1000, 0x800)
ROM_LOAD_16B("sundance.r7", 0x1001, 0x800)
ROM_END

ROM_START(wotw)
ROM_REGION(0x10000, 0)	/* 16k for code */
ROM_LOAD_16B("wow_le.t7", 0x0000, 0x1000)
ROM_LOAD_16B("wow_lo.p7", 0x0001, 0x1000)
ROM_LOAD_16B("wow_ue.u7", 0x2000, 0x1000)
ROM_LOAD_16B("wow_uo.r7", 0x2001, 0x1000)
ROM_END

ROM_START(starcas)
ROM_REGION(0x10000, 0)
ROM_LOAD_16B("starcas3.t7", 0x0000, 0x800)
ROM_LOAD_16B("starcas3.p7", 0x0001, 0x800)
ROM_LOAD_16B("starcas3.u7", 0x1000, 0x800)
ROM_LOAD_16B("starcas3.r7", 0x1001, 0x800)
ROM_END

ROM_START(tailg)
ROM_REGION(0x2000, 0)
ROM_LOAD_16B("tgunner.t70", 0x0000, 0x800)
ROM_LOAD_16B("tgunner.p70", 0x0001, 0x800)
ROM_LOAD_16B("tgunner.t71", 0x1000, 0x800)
ROM_LOAD_16B("tgunner.p71", 0x1001, 0x800)
ROM_END

ROM_START(ripoff)
ROM_REGION(0x2000, 0)
ROM_LOAD_16B("ripoff.t7", 0x0000, 0x800)
ROM_LOAD_16B("ripoff.p7", 0x0001, 0x800)
ROM_LOAD_16B("ripoff.u7", 0x1000, 0x800)
ROM_LOAD_16B("ripoff.r7", 0x1001, 0x800)
ROM_END

ROM_START(armora)
ROM_REGION(0x4000, 0)
ROM_LOAD_16B("ar414le.t6", 0x0000, 0x1000)
ROM_LOAD_16B("ar414lo.p6", 0x0001, 0x1000)
ROM_LOAD_16B("ar414ue.u6", 0x2000, 0x1000)
ROM_LOAD_16B("ar414uo.r6", 0x2001, 0x1000)
ROM_END

ROM_START(warrior)
ROM_REGION(0x10000, 0)
ROM_LOAD_16B("warrior.t7", 0x0000, 0x800)
ROM_LOAD_16B("warrior.p7", 0x0001, 0x800)
ROM_LOAD_16B("warrior.u7", 0x1000, 0x800)
ROM_LOAD_16B("warrior.r7", 0x1001, 0x800)
ROM_END

ROM_START(demon)
ROM_REGION(0x10000, 0)
ROM_LOAD_16B("demon.7t", 0x0000, 0x1000)
ROM_LOAD_16B("demon.7p", 0x0001, 0x1000)
ROM_LOAD_16B("demon.7u", 0x2000, 0x1000)
ROM_LOAD_16B("demon.7r", 0x2001, 0x1000)
ROM_END

ROM_START(boxingb)
ROM_REGION(0x10000, 0)
ROM_LOAD_16B("u1a", 0x0000, 0x1000)
ROM_LOAD_16B("u1b", 0x0001, 0x1000)
ROM_LOAD_16B("u2a", 0x2000, 0x1000)
ROM_LOAD_16B("u2b", 0x2001, 0x1000)
ROM_LOAD_16B("u3a", 0x4000, 0x1000)
ROM_LOAD_16B("u3b", 0x4001, 0x1000)
ROM_LOAD_16B("u4a", 0x6000, 0x1000)
ROM_LOAD_16B("u4b", 0x6001, 0x1000)
ROM_END
...
ROM_LOAD_16B("136016.206", 0x0001, 0x2000)
ROM_LOAD_16B("136016.102", 0x4000, 0x2000)
ROM_LOAD_16B("136016.107", 0x4001, 0x2000)
ROM_LOAD_16B("136016.203", 0x8000, 0x2000)
ROM_LOAD_16B("136016.208", 0x8001, 0x2000)
ROM_LOAD_16B("136016.104", 0xC000, 0x2000)
ROM_LOAD_16B("136016.109", 0xC001, 0x2000)
ROM_LOAD_16B("136016.105", 0x10000, 0x2000)
ROM_LOAD_16B("136016.110", 0x10001, 0x2000)
ROM_END

ROM_START(quantum1)
ROM_REGION(0x14000, 0)
ROM_LOAD_16B("136016.101", 0x0000, 0x2000)
ROM_LOAD_16B("136016.106", 0x0001, 0x2000)
ROM_LOAD_16B("136016.102", 0x4000, 0x2000)
ROM_LOAD_16B("136016.107", 0x4001, 0x2000)
ROM_LOAD_16B("136016.103", 0x8000, 0x2000)
ROM_LOAD_16B("136016.108", 0x8001, 0x2000)
ROM_LOAD_16B("136016.104", 0xC000, 0x2000)
ROM_LOAD_16B("136016.109", 0xC001, 0x2000)
ROM_LOAD_16B("136016.105", 0x10000, 0x2000)
ROM_LOAD_16B("136016.110", 0x10001, 0x2000)
...
ROM_LOAD_16B("quantump.3e", 0x000001, 0x002000)
ROM_LOAD_16B("quantump.2f", 0x004000, 0x002000)
ROM_LOAD_16B("quantump.3f", 0x004001, 0x002000)
ROM_LOAD_16B("quantump.2h", 0x008000, 0x002000)
ROM_LOAD_16B("quantump.3h", 0x008001, 0x002000)
ROM_LOAD_16B("quantump.2k", 0x00C000, 0x002000)
ROM_LOAD_16B("quantump.3k", 0x00C001, 0x002000)
ROM_LOAD_16B("quantump.2l", 0x010000, 0x002000)
ROM_LOAD_16B("quantump.3l", 0x010001, 0x002000)
ROM_END

ROM_START(bzone)
ROM_REGION(0x10000, 0)
/* Vector Generator ROMs */
ROM_LOAD("036422-01.bc3", 0x3000, 0x800)
ROM_LOAD("036421-01.a3",  0x3800, 0x800)
// Program Roms
ROM_LOAD("036414-02.e1",  0x5000, 0x800)
ROM_LOAD("036413-01.h1",  0x5800, 0x800)
ROM_LOAD("036412-01.j1",  0x6000, 0x800)
ROM_LOAD("036411-01.k1",  0x6800, 0x800)
ROM_LOAD("036410-01.lm1", 0x7000, 0x800)
ROM_LOAD("036409-01.n1",  0x7800, 0x800)
...
ROM_START(bzonea)
ROM_REGION(0x10000, 0)
ROM_LOAD("036414-01.e1", 0x5000, 0x800)
ROM_LOAD("036413-01.h1", 0x5800, 0x800)
ROM_LOAD("036412-01.j1", 0x6000, 0x800)
ROM_LOAD("036411-01.k1", 0x6800, 0x800)
ROM_LOAD("036410-01.lm1", 0x7000, 0x800)
...
ROM_LOAD("vbreak/vb_h1.bin", 0x2a800, 0x0800)
...
ROM_LOAD_16B("6.l8", 0x000000, 0x001000, 0x25f8da18)
ROM_LOAD_16B("0.n8", 0x000001, 0x001000, 0x04e20626)
ROM_LOAD_16B("7.l7", 0x002000, 0x001000, 0x230e244c)
ROM_LOAD_16B("1.n7", 0x002001, 0x001000, 0x37b12697)
ROM_LOAD_16B("8.l6", 0x004000, 0x001000, 0x1293fb9d)
ROM_LOAD_16B("2.n6", 0x004001, 0x001000, 0x712c206a)
ROM_LOAD_16B("9.l5", 0x006000, 0x001000, 0x743a6501)
ROM_LOAD_16B("3.n5", 0x006001, 0x001000, 0xa65cbf99)
ROM_LOAD_16B("a.l4", 0x008000, 0x001000, 0x9cf1b0a1)
ROM_LOAD_16B("4.n4", 0x008001, 0x001000, 0x5f0080d5)
ROM_LOAD_16B("b.l3", 0x00a000, 0x001000, 0x8cc7f7fa)
ROM_LOAD_16B("5.n3", 0x00a001, 0x001000, 0x40452376)

ROM_REGION(0x10000, REGION_CPU2)
ROM_LOAD("c.j4", 0x0000, 0x1000, 0xe897dfcd)
ROM_LOAD("d.j3", 0x1000, 0x1000, 0x4016de77)
ROM_END
