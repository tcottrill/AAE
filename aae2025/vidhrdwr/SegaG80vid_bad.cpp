					...
					if (newclip != clipped)
					{
						...
						/* otherwise, add a colored point */
							...
							if (intensity)
							{
								if (sega_rotate)
								{
									emuscreen->add_line((sy >> 16), (sx >> 16), (adjy >> 16), (adjx >> 16), color, color);
									...
									emuscreen->add_line((sx >> 16), (sy >> 16), (adjx >> 16), (adjy >> 16), color, color);
