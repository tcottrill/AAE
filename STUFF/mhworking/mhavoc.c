...
{   
	...
	dwElapsedTicks = m6502zpGetElapsedTicks(0xff);
		...
		for (x=0; x < 400; x++)
		{
				...
				dwResult = m6502zpexec(cycles1/400);		// 1500 Instructions for 1.5MHZ CPU
                ...
                switch(x)
				{
				case 50: m6502zpint(1);break;
				case 100: m6502zpint(1);break;
				case 150: m6502zpint(1);break;
				case 200: m6502zpint(1);break;
				case 250: m6502zpint(1);break;
				case 300: m6502zpint(1);break;
				case 350: m6502zpint(1);break;
				case 398: m6502zpint(1);break;
				}
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////
				...
				dwResult =m6502zpexec(cycles2/400);		// 1500 Instructions for 1.5MHZ CPU
				if (0x80000000 != dwResult)
					{
