...
MEM_READ(AlphaOneRead)
 ...
 MEM_ADDR(0x1060, 0x1060, mhavoc_port_1_r)//alphaone_port_1_r)		/* Gamma Input Port	*/
...
int init_mhavoc(void)
{
    ...
    if (gamenum==ALPHAONE) has_gamma_cpu=0; else has_gamma_cpu=1;
