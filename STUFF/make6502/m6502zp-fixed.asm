...
; Using register calling conventions
...
dwElapsedTicks2	dd 0	; Elapsed ticks counter number two!
...
ReadMemoryByte:
		...
		mov	eax, edx	; Get our desired address reg
		mov	edx, edi	; Pointer to the structure
...
callRoutine5:
		...
		mov	edx, ebx	; The byte value
		mov	ebx, edi	; MemoryWriteByte structure
		call	dword [edi + 8] ; Go call our handler
...
getTicks:
		...
		ret
;----------------------------------------------------------------
;global	_m6502zpGetElapsedTicks2
;		global	m6502zpGetElapsedTicks2_

;times ($$-$) & 3 nop	; pad with NOPs to 4-byte boundary

;m6502zpGetElapsedTicks2_:
;_m6502zpGetElapsedTicks2:
;		or	eax, eax	; Should we clear it?
;		jz	getTicks2
;		xor	eax, eax
