...
{
        { 
        "aae", "AAE GUI",  asterock, &init_gui,0,&run_gui, &end_gui,
        gui_dips, default_keys, 
	    guisamples, noart, 
		...
		&init_cinemat,0,&run_cinemat, &end_cinemat, 
		cinemat_dips, sundance_keys, sundance_samples, sundance_art,
		{CPU_CCPU,CPU_NONE,CPU_NONE,CPU_NONE},
		{3000000,0,0,0},
		{10,0,0,0},
		{1,0,0,0},
		...
		&init_cinemat,0,&run_cinemat, &end_cinemat, 
		cinemat_dips, warrior_keys, warrior_samples, warrior_art,
		{CPU_CCPU,CPU_NONE,CPU_NONE,CPU_NONE},
		{3000000,0,0,0},
		{10,0,0,0},
		{1,0,0,0},
		...
		&init_cinemat,0,&run_cinemat, &end_cinemat, 
		cinemat_dips, ripoff_keys, ripoff_samples, ripoff_art,
		{CPU_CCPU,CPU_NONE,CPU_NONE,CPU_NONE},
		{3000000,0,0,0},
		{10,0,0,0},
		{1,0,0,0},
		...
		&init_cinemat,0,&run_cinemat, &end_cinemat,
		cinemat_dips, tailg_keys, tailg_samples, tailg_art,
		{CPU_CCPU,CPU_NONE,CPU_NONE,CPU_NONE},
		{3000000,0,0,0},
		{10,0,0,0},
		{1,0,0,0},
...
void run_game(void)
{
   ...
   while (!done)
	{  
		set_render();
		if (driver[gamenum].cpu_type[0]==CPU_6502Z)
		{
