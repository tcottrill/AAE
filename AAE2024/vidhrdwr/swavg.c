            ...
            if (z){
				...
				if (blue) { blue=z;}
				 ...
				 {add_color_point((currentx>>VEC_SHIFT),currenty>>VEC_SHIFT, blue,green,red);}
				      ...
				      add_color_line((float) (currentx>>VEC_SHIFT), (float) (currenty>>VEC_SHIFT), (float) ((currentx+deltax)>>VEC_SHIFT),  (float) ((currenty-deltay)>>VEC_SHIFT),(int) blue, (int)green, (int)red);
