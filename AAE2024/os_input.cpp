...
const char* osd_key_name(int keycode)
{
	...
	{
		"ESC", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "MINUS", "EQUAL", "BKSPACE",         //14
		"TAB", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "OPBRACE", "CLBRACE", "ENTER",       //14
		"LCTRL", "A", "S", "D", "F", "G", "H", "J", "K", "L", "COLON", "QUOTE", "TILDE",              //13
		"LSHIFT", "Error", "Z", "X", "C", "V", "B", "N", "M", "COMMA", ".", "SLASH", "RSHIFT",        //13
		"*", "ALT", "SPACE", "CAPSLOCK", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", //14
		"NUMLOCK", "SCRLOCK", "HOME", "UP", "PGUP", "MINUS PAD",  //6
		"LEFT", "5 PAD", "RIGHT", "PLUS PAD", "END", "DOWN",      //6
		"PGDN", "INS", "DEL", "PRTSCR", "Error", "Error",		  //6
		"F11", "F12", "Error", "Error",							  //4
		"LWIN", "RWIN", "MENU", "RCTRL", "ALTGR", "PAUSE",        //6
		"Error", "Error", "Error", "Error",						  //4
		"1 PAD", "2 PAD", "3 PAD", "4 PAD", "Error",			  //5
		"6 PAD", "7 PAD", "8 PAD", "9 PAD", "0 PAD",			  //5
		". PAD", "= PAD", "/ PAD", "* PAD", "ENTER PAD",          //5
	};
