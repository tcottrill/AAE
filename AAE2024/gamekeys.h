...
//Cinematronics Switch Definitions from Aaron Giles
...
/*
	...
	PORT_START("IN3") /* joystick X */
	PORT_BIT(0xff, IP_ACTIVE_LOW, IPT_UNUSED)

	PORT_START("IN4") /* joystick Y */
	PORT_BIT(0xff, IP_ACTIVE_LOW, IPT_UNUSED)
	INPUT_PORTS_END
