...
int quantum_input_1_r(unsigned address)
{
	return (readinputportbytag("DSW0") << (7 - (address - POT0_C))) & 0x80;
}


int quantum_input_2_r(unsigned address)
{
	return (readinputportbytag("DSW1") << (7 - (address - POT0_C))) & 0x80;
}
